...
<div class="project-card">
  ...
  <ul>
    <li>Integrated OpenCage & Open-Meteo APIs for real-time geolocation and weather-based suggestions.</li>
    <li>Built responsive React frontend with custom components.</li>
...
<div class="project-card">
  ...
  <ul>
    ...
    <li>Built RESTful backend with FastAPI and SQLAlchemy ORM.</li>
    <li>Responsive React UI with charts for expense visualization.</li>
  </ul>
  <div class="project-buttons">
...
<div class="project-card">
  ...
  <p>A web application where users can browse, add, and review movies.</p>
  ...
  <ul>
    ...
    <li>Interactive frontend built with vanilla JavaScript.</li>
  </ul>
  <div class="project-buttons">
...
<div class="project-card">
  <h2>Blog App</h2>
  <p>A full-stack blogging platform with authentication, CRUD posts, and comments.</p>
  <p><strong>Stack:</strong> FastAPI • PostgreSQL • React</p>
  <ul>
    <li>Secure user authentication with password hashing.</li>
    <li>CRUD functionality for posts and comments.</li>
    <li>React frontend integrated with backend API for smooth UX.</li>
  </ul>
  <div class="project-buttons">
